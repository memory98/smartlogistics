...
const MyData = ({ info, setUserInfo }) => {
  ...
  const handleFileChange = (event) => {
    ...
    var fileForm = selectedFile.name.split('.');
        ...
        >
          ...
          >
            <Table size="small" sx={{ width: '100%' }}>
              <TableBody>
                <TableRow>
                  <TableCell component="th" scope="row" sx={{ backgroundColor: '#F6F7F9', width: '30%', fontWeight: '800' }}>
                    아이디
                  </TableCell>

                  <TableCell align="left" sx={{ padding: '6px 0px 6px 4px', display: 'flex' }}>
                    <TextField
                      disabled
                      type="text"
                      id="id"
                ...
                <TableRow>
                  <TableCell component="th" scope="row" sx={{ backgroundColor: '#F6F7F9', fontWeight: '800' }}>
                    비밀번호
                  </TableCell>
                  ...
                  <TableCell align="left" sx={{ padding: '6px 0px 6px 4px', display: 'flex' }}>
                    ...
                    />
                    {messages.pwd != '' && <Typography sx={{ color: 'red', marginLeft: '5%' }}>{messages.pwd}</Typography>}
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell component="th" scope="row" sx={{ backgroundColor: '#F6F7F9', fontWeight: '800' }}>
                  ...
                  <TableCell align="left" sx={{ padding: '6px 0px 6px 4px', display: 'flex' }}>
                    <TextField
                      ...
                      placeholder="영어,숫자 포함 최소 9자~최대20자"
                    />
                    {messages.pwdchk != '' && <Typography sx={{ color: 'red', marginLeft: '5%' }}>{messages.pwdchk}</Typography>}
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell component="th" scope="row" sx={{ backgroundColor: '#F6F7F9', fontWeight: '800' }}>
                  ...
                  <TableCell align="left" sx={{ padding: '6px 0px 6px 4px', display: 'flex' }}>
                    <TextField
                      ...
                      onChange={(e) => onChangeHandle(e)}
                    />
                    {messages.name != '' && <Typography sx={{ color: 'red', marginLeft: '5%' }}>{messages.name}</Typography>}
                  </TableCell>
                </TableRow>

                <TableRow>
                  <TableCell component="th" scope="row" sx={{ width: '200px', backgroundColor: '#F6F7F9', fontWeight: '800' }}>
                    전화번호
                  </TableCell>
                  ...
                  <TableCell align="left" sx={{ padding: '6px 0px 6px 4px', display: 'flex' }}>
                    <TextField
                      ...
                      sx={{ width: '40%' }}
                    />
                    {messages.phone != '' && <Typography sx={{ color: 'red', marginLeft: '5%' }}>{messages.phone}</Typography>}
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
            <Button type="submit" variant="outlined" sx={{ float: 'right', width: 100, marginTop: 1 }} onClick={validateForm}>
              수정
            </Button>
          </TableContainer>
        </Box>
